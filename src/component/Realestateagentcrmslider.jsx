...
const Realestateagentcrmslider = () => {
  const icons = [
  ...
  Simplify your workflow and focus on what matters with <br />
  PureSaaS — the ultimate solution for smooth operations.
</h2>

{/* Description */}
<span style={{ textAlign: "justify" }}>
  PureSaaS lets you manage tasks, collaborate with your team, and stay in control—all in one simple platform.
</span>
...
export default Realestateagentcrmslider;
